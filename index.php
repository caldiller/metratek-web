...
<p>Metratek provides expertise in electronic instrument design, with expertise in the following areas:</p>
<ul>
	<li>Wide bandwidth analog (DC to > 1GHz), time and frequency domain</li>
	<li>Precision DC analog</li>
	<li>Signal generation and acquisition</li>
	<li>Linear and switching power supplies</li>
	<li>System level instrument architecture</li>
</ul>
